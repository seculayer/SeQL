...
## 1. Overview
<center><img src="https://user-images.githubusercontent.com/58262527/70760960-ccfe4980-1d8e-11ea-92d0-5fce99b6bdef.png" width="300" height="100"></center>
...
[ Grammar and example ]
	RDB.DSN_01[SQL Query]
[ Description ]
- RDB : Prefix for an RDB data source
- DSN_01 : ID of the RDB data source
- SQL Query : Database’s SQL query
