...
SeQL, abbreviated from [Seculayer](http://www.seculayer.com/en/){:target="_blank" rel="noopener"} Query Language, is a query language developed by [Seculayer](http://www.seculayer.com/en/)’s R&D center.
...
SeQL is installed and executed in ShovelServer process in the Analyzer of [eyeCloudSIM](http://www.seculayer.com/en/?c=117) as shown in the architecture below. Basically, SeQL can search the data stored in [eyeCloudSIM](http://www.seculayer.com/en/?c=117) and can search the internal and external RDB and file data.
...
SeQL consists of the structure of Data Search -> Data Processing-> Data Output Printing. Data search is performed from [eyeCloudSIM](http://www.seculayer.com/en/?c=117) search engine data, DB data, file data and more. 

### 3.1  Data Search
#### 1)	Data search from search engine
Search engine data can be retrieved using LuceneQL, the search language of the [eyeCloudSIM](http://www.seculayer.com/en/?c=117) search engine.
...
#### 3)	File data source
File data registered on [eyeCloudSIM](http://www.seculayer.com/en/?c=117) is retrieved for data search. 
...
The table below shows an example to search index data stored in [eyeCloudSIM](http://www.seculayer.com/en/?c=117).
...
Basically, both TOP/BOTTOM and HEAD/TAIL are used to cut data from the beginning or the end, yet the purpose varies. TOP/BOTTOM is used to cut the data from [eyeCloudSIM](http://www.seculayer.com/en/?c=117) index data in search statements and HEAD/TAIL is used to cut the data while processing the data. 
...
### 4.5  Search Filter
Below shows an example of search filter for correlation analysis when searching for [eyeCloudSIM](http://www.seculayer.com/en/?c=117) index data. It is following the form of | SEARCH src_ip IN [SeQL].
...
The table below shows an example of search using RDB data source registered on [eyeCloudSIM](http://www.seculayer.com/en/?c=117).
...
The table below shows an example of search using file data source registered on [eyeCloudSIM](http://www.seculayer.com/en/?c=117).
